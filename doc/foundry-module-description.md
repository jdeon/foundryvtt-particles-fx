...
The module contains several methods to generate particles using a json input. The particles are simples sprites textures managed by script, no need of video files. You can generate emission by chat message, macro or api calls.
